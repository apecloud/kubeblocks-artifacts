...
def draw_fit_text(
    ...
    draw.multiline_text((x1, y1), text, font=font, fill=BLACK, spacing=int(min_size * 0.2), align=align)
...
def main() -> None:
    ...
    xiaohei_line = "One script per database.\nI'm\u2026 organized."

    # Xiaohei line: black text in open whitespace, no bubble or text box.
    draw_fit_text(draw, (930, 305, 1545, 445), xiaohei_line, max_size=58, min_size=38, align="left")
